...
import { ArrowRight, Wallet, MessageCircle, TrendingUp, Smartphone } from 'lucide-react';
        ...
        <div className="grid gap-12 md:grid-cols-2 md:gap-16 items-center">
          ...
          >
            ...
            <div className="mt-6 pt-4">
              <p className="text-sm text-muted-foreground mb-3">Mobile apps coming soon:</p>
              <div className="flex flex-wrap gap-3">
                <motion.div
                  className="glass-card px-4 py-3 flex items-center gap-2 cursor-pointer group"
                ...
                >
                  ...
                  <Badge variant="purple" className="ml-1 text-[10px] py-0">Soon</Badge>
                </motion.div>
                ...
                >
                  ...
                  <Badge variant="green" className="ml-1 text-[10px] py-0">Soon</Badge>
                </motion.div>
              </div>
            </div>
          </motion.div>
