...
const StoreBadges = () => {
  return <div className="flex items-center justify-start gap-4 mt-6 py-[10px]">
      ...
      scale: 0.95
        ...
        <Badge variant="purple" className="px-4 py-2 flex items-center gap-2 border-none">
      ...
      scale: 0.95
        ...
        <Badge variant="green" className="px-4 py-2 flex items-center gap-2 border-none">
